...
/* NVS partition and per-slot backup areas */
#define MAIN_NVS_OFFSET     0xA000
#define MAIN_NVS_SIZE       0x4000      /* 16KB, 4 sectors */
#define NVS_BACKUP_BASE     0xD10000    /* 4 × 16KB = 64KB */
